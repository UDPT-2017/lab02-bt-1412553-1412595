...
Thành viên:
* [x] **1412553** Tên sinh viên 1 (tqhb1995)
* [x] **1412595** Tên sinh viên 2 (VoThiThanhTruc)
...
Yêu cầu **bắt buộc**
* [x] Website layout theo kiến trúc MVC với các thành phần được tách thành nhiều module theo hướng dẫn. (**1412553**)
* [x] Trang web được thiết kế sẽ bao gồm các trang: home, messages, users, about. (**1412553**)
* [x] Cho phép người dùng biết họ đang ở trang nào (sử dụng breadcrumb, highlight navigation bar,...). (**1412595**)
* [x] Cho phép người dùng đăng ký tài khoản bằng các thông tin: email, password, name, phone.(**1412553**)
...
* [x] Trang about thể hiện thông tin nhóm thực hiện đề tài.(**1412595**)
